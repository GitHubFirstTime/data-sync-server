...
import com.rlc.rlcframework.web.service.CacheService;
...
public class CacheController extends BaseController
{
    ...
    @ResponseBody
    public ResultData clearCacheName(String cacheName, ModelMap mmap)
    {
    ...
    @ResponseBody
    public ResultData clearCacheKey(String cacheName, String cacheKey, ModelMap mmap)
    {
    ...
    @GetMapping("/clearAll")
    @ResponseBody
    public ResultData clearAll(ModelMap mmap)
    {
