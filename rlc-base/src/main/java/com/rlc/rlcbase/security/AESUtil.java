 ...
 * Function: AES加解密工具类 ADD FUNCTION. <br/>
 * Reason:	 AES加解密工具类 ADD REASON. <br/>
 *
 * @author RLC_ZYC
 * @version 1.0
...
public class AESUtil {
    ...
    public static String decode(String content, String myKey) {
        try {
            ...
            throw new RuntimeException("兄弟，配置文件中的密码需要使用AES加密，请使用com.rlc.cmdbServer.common.security.AESUtil工具类修改这些值！");
        } catch (BadPaddingException e) {
            e.printStackTrace();
        }
        return null;
